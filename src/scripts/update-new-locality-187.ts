...
async function updateNewListingsLocality() {
    console.log('🏠 Starting NEW listings locality update process...');
    ...
    try {
        ...
        console.log(`📊 Found ${listings.length} NEW listings to process`);
        ...
        for (const listing of listings) {
            ...
            if (!hasLatitude || !hasLongitude) {
                ...
                // Has coordinates: reverse geocode to get locality
        ...
        console.error('❌ Error during NEW listings locality update:', error);
        throw error;
    }
}

async function updateNewProjectsLocality() {
    console.log('🏗️ Starting NEW projects locality update process...');
    ...
    try {
        ...
        console.log(`📊 Found ${projects.length} NEW projects to process`);
        ...
        console.error('❌ Error during NEW projects locality update:', error);
        throw error;
    }
}
