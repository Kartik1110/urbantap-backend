...
//version 2
//   import { PrismaClient, Broker, Type } from "@prisma/client";
// import { faker } from "@faker-js/faker";
// import { realDevelopers, realBrokerages, sampleListings } from "./realData";
...
//   console.log("Inserting real developers...");

//   const realDeveloperEntries = await Promise.all(
//     realDevelopers.map(async (dev) => {
...
//   console.log("Inserting real brokerages...");

//   const realBrokerageEntries = await Promise.all(
//     realBrokerages.map(async (b) => {
//       const company = await prisma.company.create({
//         data: {
//           name: b.name,
//           type: "Brokerage",
...
//   console.log("Creating real brokers...");

//   const realBrokers: Broker[] = [];
...
//     const company = useDev
//       ? realDeveloperEntries[i % realDeveloperEntries.length].company
//       : realBrokerageEntries[i % realBrokerageEntries.length].company;
...
//   console.log("Creating real listings for real brokers...");

// await Promise.all(
//   sampleListings.map(async (listing, idx) => {
//     const broker = realBrokers[idx % realBrokers.length];
...
//         type: listing.type as Type,
//         category: listing.category as Category,
//         no_of_bedrooms: listing.no_of_bedrooms as Bedrooms,
//         no_of_bathrooms: listing.no_of_bathrooms as Bathrooms,
//         furnished: listing.furnished as Furnished,
//         payment_plan: listing.payment_plan as Payment_Plan,
//         sale_type: listing.sale_type as Sale_Type,
//         handover_quarter: listing.handover_quarter as Quarter,
//         type_of_use: listing.type_of_use as Type_of_use,
//         deal_type: listing.deal_type as DealType,
//         current_status: listing.current_status as CurrentStatus,
//         views: listing.views as Views,
//         market: listing.market as Market,
//         city: listing.city as City, // ✅ This is the final fix
//       },
//     });
//   })
// );
